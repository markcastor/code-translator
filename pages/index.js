...
export default function Home() {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      <p className="font-sans mt-5 pb-5">Powered by <a className="ref-link text-[#C53AAE]" href="http://castorMark.so/" target="_blank" rel="noopener noreferrer">castorMark </a></p>
